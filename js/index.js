...
$(window).on('load', function() {
    ...
    $(function() {
        gsap.to('.img-container', 1, {
            height: 0
        });
        gsap.to('.image-type', 1, {
            height: 0,
            opacity: 0
        });
        gsap.to('.navigation-bar', 1, {
            opacity: 0
        });
        gsap.to('.swiper-pagination', 1, {
            opacity: 0
        });
        gsap.to('.about-link', 1, {
            opacity: 0
        });
            ...
            onComplete: function() {
                ...
                gsap.to('#loader', 1.2, { //LOADING PAGE TRANSITION
                    ...
                    onComplete: function() {
                        ...
                        gsap.to('.navigation-bar', .5, {
                            opacity: 1,
                            delay: 1.5
                        });
                        gsap.to('.swiper-pagination', .5, {
                            opacity: 1,
                            delay: 1.5
                        });
                        gsap.to('.about-link', .5, {
                            opacity: 1,
                            delay: 1.5
                        });
                    }
